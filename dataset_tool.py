...
class TFRecordExporter:
    ...
    def rgba2rgb(self, rgba):
        self.ch, self.row, self.col = rgba.shape
        #assert self.ch == 4, 'RGBA image has 4 channels.'

        self.rgb = np.zeros((3, self.row, self.col), dtype='float32')
        ...
        return np.asarray(self.rgb, dtype='uint8')
